namespace Microsoft.Samples.Kinect.ControlsBasics.DataModel
{
    ...
    public sealed class SampleDataSource
    {
        ...
        {
            Uri itemContent = new Uri("Videos/Hells_Kitchen.mp4", UriKind.Relative);
            Uri itemFigure = new Uri("Images/hellsKitchen.jpg", UriKind.Relative);
            var group1 = new SampleDataCollection(
                    "Group-1",
                    "Group Title: 3",
                    "Group Subtitle: 3",
                    new Uri("Assets/DarkGray.png", UriKind.Relative),
                    "Group Description: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus tempor scelerisque lorem in vehicula. Aliquam tincidunt, lacus ut sagittis tristique, turpis massa volutpat augue, eu rutrum ligula ante a ante");
            group1.Items.Add(
                    new SampleDataItem(
                        "Group-1-Item-5",
                        "Hells kitchen episode 5",
                        "The worst Hells kitchen episode",
                        itemFigure,
                        "The worst Hells kitchen episode",
                         4, itemContent,
                        group1,
            ...
            group1.Items.Add(
                    new SampleDataItem(
                        ...
                        "Item Title: 2",
                        "Item Subtitle: 2",
                         new Uri("Assets/MediumGray.png", UriKind.Relative),
            ...
            group1.Items.Add(
                    new SampleDataItem(
                        ...
                        "Item Title: 5",
                        "Item Subtitle: 5",
                         new Uri("Assets/LightGray.png", UriKind.Relative),
                        "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
    ...
    public class SampleDataItem : SampleDataCommon
    {
        ...
        /// <summary>
        /// Field to store rating
        /// </summary>
        private int rating;

        public SampleDataItem(string uniqueId, string title, string subtitle, Uri imagePath, string description, int rating, Uri content, SampleDataCollection group)
        ...
        public SampleDataItem(string uniqueId, string title, string subtitle, Uri imagePath, string description, int rating, Uri content, SampleDataCollection group, Type navigationPage)
            : base(uniqueId, title, subtitle, imagePath, description)
        {
            this.content = content;
            this.group = group;
    ...
    public class SampleDataCollection : SampleDataCommon, IEnumerable
    {
        ...
        public SampleDataCollection(string uniqueId, string title, string subtitle, Uri imagePath, string description)
            : base(uniqueId, title, subtitle, imagePath, description)
        {
            //possible to sort the items with ranking
        ...
        private void ItemsCollectionChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            ...
            switch (e.Action)
            {
                //starting index is for the item with the action
