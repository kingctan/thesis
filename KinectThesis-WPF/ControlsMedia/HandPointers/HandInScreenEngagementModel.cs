namespace Microsoft.Samples.Kinect.ControlsBasics
{
    ...
    /// Engagement signal: putting hand in screen
    ...
    public class HandInScreenEngagementModel : IKinectEngagementManager
    {
        ...
        private bool engagementPeopleHaveChanged;
        private List<BodyHandPair> handsToEngage;
        private int engagedPeopleAllowed;

        //points of a hand and a hand cursor
        private List<KinectPointerPoint> pointerPoints;

        private TimeSpan lastFrameTime = TimeSpan.Zero;
        private InputPointerManager inputPointerManager;
        ...
        private void kinectCoreWindow_PointerMoved(object sender, KinectPointerEventArgs e)
        {
            ...
            //timestamp association between pointer and body
