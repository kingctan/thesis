...
namespace Microsoft.Samples.Kinect.SpeechBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private static readonly Dictionary<Direction, Direction> TurnRight = new Dictionary<Direction, Direction>
            {
                ...
                { Direction.Down, Direction.Miguel },
                { Direction.Miguel, Direction.Up }
            };

        /// <summary>
        /// Map between each direction and the direction immediately to its Miguel.
        /// </summary>
        private static readonly Dictionary<Direction, Direction> TurnMiguel = new Dictionary<Direction, Direction>
            {
                { Direction.Up, Direction.Miguel },
                { Direction.Right, Direction.Up },
                { Direction.Down, Direction.Right },
                { Direction.Miguel, Direction.Down }
            };
        ...
        private static readonly Dictionary<Direction, Point> Displacements = new Dictionary<Direction, Point>
            {
                ...
                { Direction.Miguel, new Point { X = -1, Y = 0 } }
            };
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (null != ri)
            {
                this.recognitionSpans = new List<Span> { forwardSpan, backSpan, rightSpan, MiguelSpan };
                ...
                * directions.Add(new SemanticResultValue("turn Miguel", "Miguel"));
        ...
        private void SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            ...
            if (e.Result.Confidence >= ConfidenceThreshold)
            {
                switch (e.Result.Semantics.Value.ToString())
                {
                    ...
                    case "Miguel":
                        MiguelSpan.Foreground = Brushes.DeepSkyBlue;
                        MiguelSpan.FontWeight = FontWeights.Bold;
                        this.curDirection = TurnMiguel[this.curDirection];

                        // We take a Miguel turn to mean a counter-clockwise right angle rotation for the displayed turtle.
